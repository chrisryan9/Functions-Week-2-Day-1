...
console.log(bestMovie('The Hangover'))
...
const string = sampleString.toUpperCase()
...
console.log(emailCheck('chris@gmail.com'))
...
const chocoFrogs = (gold) => {
  return gold / 3;
}


let totalFrogs = chocoFrogs(33)
